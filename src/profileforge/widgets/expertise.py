...
from profileforge.components.layout import Column, Padding, Component
...
class ExpertiseWidget(Widget):
    def build(self, context: BuildContext) -> Component:
        ...
        return Card(title="Backend Expertise", child=Padding(child=content, value=25), style=Style(width=400))
