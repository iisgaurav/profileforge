...
class LayoutEngine:
    ...
    def calculate(component: Component, start_x: int = 0, start_y: int = 0):
        ...
        if isinstance(component, Spacer):
            ...
            component.computed_height = current_y - start_y - (component.spacing if component.children else 0)
            ...
            component.computed_width = current_x - start_x - (component.spacing if component.children else 0)
            ...
            card_h = component.style.height or (component.child.computed_height + title_offset + 20)
